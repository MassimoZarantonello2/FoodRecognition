...
class EnsambleModel():
    ...
    def train_ensamble(self, train_dataset, lr, num_epochs=10, lc=None):
        ...
        for model_name in self.models_name:
            ...
            train_loss, val_loss, train_accuracies, val_accuracies = model.train_model(train_dataset, validation=0.2, lr=lr, num_epochs=num_epochs, cycle=-1)
    ...
    def get_models(self):
        for model_name in self.models_name:
            ...
            model.load_model('./models/trained_models/' + model_name + '_-1.pth')
            self.models.append(model)
        return self.models
